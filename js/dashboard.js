    ...
    if (userSnap.exists()) {
        ...
        userData = {
            ...
            permissions: {
                ...
                years: { access: initialRole === 'super_admin' },
...
function showDashboard(user, userData) {
    ...
    const moduleYears = document.getElementById('module-years');
    ...
    moduleYears.classList.add('hidden');
    ...
    // 5. Check quyền Module Năm Học
    if (userData.role === 'super_admin' || hasPermission(userData.permissions, 'years', 'access')) {
        moduleYears.classList.remove('hidden');
    }
